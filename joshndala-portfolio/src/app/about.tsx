...
export default function About() {
  ...
  return (
    <section className="bg-secondary dark:bg-primary py-8 sm:py-12 md:py-16 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <Typography variant="h2" className="mb-6 sm:mb-8 text-center text-3xl sm:text-4xl text-primary dark:text-secondary/90">
          About Me
        </Typography>
        <div className="flex flex-col lg:flex-row items-start">
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
            <Typography variant="lead" className="mb-4 text-primary dark:text-secondary/90 text-base sm:text-lg font-medium">
            ...
            <Typography variant="paragraph" className="mb-4 text-primary/80 dark:text-secondary/80 text-sm sm:text-base">
            ...
            <Typography variant="paragraph" className="text-primary/80 dark:text-secondary/80 text-sm sm:text-base">
          ...
          <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
            <Typography variant="h5" className="mb-4 text-xl sm:text-2xl text-primary dark:text-secondary/90">
